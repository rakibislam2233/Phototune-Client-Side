        ...
        <div className="md:flex justify-between gap-8 py-5 space-y-6 md:space-y-0">
          <div className="w-full space-y-3 md:w-[40%]">
            <Link to={"/"}>
              <img
                className="w-20 h-20"
                src="https://i.postimg.cc/3RcPXm7b/logo.png"
                alt=""
              />
            </Link>
            <h3 className="tracking-wider">
              Why I say old chap that is sping lavatory chip shop gosh off his
              smashing boot are you taking the piss posh loo brilliant matie boy
              young.!!
            </h3>
          ...
          <div className="w-full md:w-[20%] space-y-3">
            ...
            <ul className=" flex flex-col gap-3">
              <li className="hover:text-teal-500 transition-all duration-500">
                <Link>All NFTs</Link>
              </li>
              <li className="hover:text-teal-500 transition-all duration-500">
